    ...
    return (
        <footer className="relative text-white p-8 mt-8 bg-gray-800 dark:bg-black">
            ...
            <div className="relative z-10 container mx-auto">
                <h2 className="text-xl font-bold mb-4">Phim chất lượng cao online của XemPhim khác gì so với các trang phim khác?</h2>
                <ul className="list-disc pl-5 space-y-2 mb-4">
                    <li>
                        Là phim bluray (reencoded), có độ phân giải thấp nhất là Full HD (1080p), trong khi hầu hết các trang phim khác chỉ
                        có độ phân giải HD (720p) là cao nhất
                    </li>
                    <li>
                        Chất lượng cao, lượng dữ liệu trên giây (bitrate) gấp từ 5 - 10 lần phim online thông thường - đây là yếu tố quyết
                        định độ nét của phim (thậm chí còn quan trọng hơn độ phân giải)
                    </li>
                    ...
                    <li>
                        Có lựa chọn hiển thị phụ đề song ngữ (tức hiện đồng thời cả tiếng Anh & tiếng Việt), phù hợp với những người muốn
                        học tiếng Anh qua phụ đề phim
                    </li>
                </ul>
                {/* Social Icons */}
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span className="text-sm text-gray-500 ">
                            ©<a href="https://www.facebook.com/letiendat912">botdz</a> 2024, All rights reserved.
                        </span>
