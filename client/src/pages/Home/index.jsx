...
function Home() {
    return (
        <>
            <Banner />
            <div className="pt-[20px] dark:bg-slate-800 dark:text-gray-400 s360:px-[0px] s375:px-[0px] s412:px-[0px] s480:px-[10px] s640:px-[10px] s768:px-8 s800:px-[0px] s900:px-[40px] s1024:px-[40px] s1280:px-[40px] s1366:px-[40px]">
                <MovieSlider movies={movies} speed={8000} />
                <div className="s360:mx-[10px] s375:mx-[10px] s412:mx-[10px] s480:px-[10px]">
